...
/*:
 * @target MZ
 * @plugindesc v1.041 Place enemy groups automatically and randomly.
...
/*:ja
 * @target MZ
 * @plugindesc v1.041 敵グループを自動でランダム配置します。
 ...
 * 【独自実装】配置計算を開始
 */
Sprite_Enemy.prototype.startAutoPosition = function(bestDistance) {
 ...
 * 【独自実装】総当り方式で位置を決定
 */
Sprite_Enemy.prototype.makeAutoPositionWithBruteForce = function(
        endX, endY, gridCountX, gridCountY, sprites, bestDistance) {
    var distanceList = [];
 ...
 * 【独自実装】ランダム方式で位置を決定
 */
Sprite_Enemy.prototype.makeAutoPositionAtRandom = function(
        endX, endY, gridCountX, gridCountY, sprites, bestDistance) {
    var distanceList = [];
