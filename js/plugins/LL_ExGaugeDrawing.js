//=============================================================================
// RPGツクールMZ - LL_ExGaugeDrawing.js
//=============================================================================
...
(() => {
	...
	const normalGaugeSettings = {"gaugeColor1":"#fff","gaugeColor2":"#fff","lowPercentage":"0","gaugeAlertColor1":"#ff2020","gaugeAlertColor2":"#ff784c","lowAlert":"none","maxValueEnable":"false","gaugeX":"0"};
	...
	Sprite_Gauge.prototype.updateLowAlert = function(gaugeSettings) {
		const rate = this.gaugeRate();
		if (String(gaugeSettings.lowAlert) != "none" && rate < Number(gaugeSettings.lowPercentage) / 100) {
