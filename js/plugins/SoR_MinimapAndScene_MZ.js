...
// ----------------------------------------------------------------------------
// Latest version v1.00　(2020/09/01)
//=============================================================================
...
Scene_SoREntireMap.prototype.createAreaMapWindows = function(){
      ...
      if(UseLegend_AreaMapScene){
        this._Legendwindow = new Window_Base(new Rectangle(0,120,152,156));
